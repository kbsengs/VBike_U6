...
public class BMX_Multi_InGame : GameState
{

    #region Members
    BMX_Multi_Data _Data;
...
// Unity6: //if (Network.isServer)
                    ...
                    //    }
                    //}
                    AudioCtr.Play(AudioCtr.snd_bgm[GameData.BMXMap + 1], AudioCtr.BGM_VALUME, true);
                    creatUser = true;
                }
...
// Unity6: networkView.RPC("SendSyncState", RPCMode.Others, _Data._ServerState, _Data._ServerTime);
            ...
            else
            {
                ...
                {
                    StartPointControl sp = GameObject.Find(GameData.bmxStart[GameData.BMXMap + 1]).GetComponent<StartPointControl>();
...
// Unity6: if (Network.isServer)
        ...
        else if (_Data._ServerState == 6)
        {
            ...
            gameObject.AddComponent<BMX_Multi_Result>();
            StateControl.gameMng.SetState(typeof(BMX_Multi_Result));
    ...
    {
        AudioCtr.Stop(AudioCtr.snd_bgm[GameData.BMXMap + 1]);
    ...
    {
        //AsyncOperation async = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync(GameData.map[3]);
